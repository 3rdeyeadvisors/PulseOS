...
export const MagicLinkEmail = ({ siteName, confirmationUrl }: MagicLinkEmailProps) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Your login link for PulseOS</Preview>
    <Body style={main}>
      <Container style={container}>
        <Section style={header}>
          <Heading style={headerTitle}>🔗 Your Login Link</Heading>
        </Section>
        <Section style={body}>
          <Text style={text}>Click the button below to log in to PulseOS. This link will expire shortly.</Text>
