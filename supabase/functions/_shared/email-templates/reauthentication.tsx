    ...
    <Body style={main}>
      <Container style={container}>
        <Section style={header}>
          <Heading style={headerTitle}>🔑 Verification Code</Heading>
        </Section>
        <Section style={body}>
...
const codeStyle = { fontFamily: 'Courier, monospace', fontSize: '32px', fontWeight: 'bold' as const, color: '#E04F3E', margin: '0 0 30px', textAlign: 'center' as const, letterSpacing: '4px' }
