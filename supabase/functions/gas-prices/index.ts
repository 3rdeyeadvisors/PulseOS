...
// Regional base prices based on US gas price averages by state (Dec 2024 estimates)
const regionalBasePrices: Record<string, number> = {
  // West Coast (highest prices)
  'california': 4.50, 'ca': 4.50,
  'hawaii': 4.40, 'hi': 4.40,
  'washington': 3.90, 'wa': 3.90,
  'oregon': 3.80, 'or': 3.80,
  'nevada': 3.70, 'nv': 3.70,
  'alaska': 3.60, 'ak': 3.60,
  
  // Northeast
  'new york': 3.40, 'ny': 3.40,
  'massachusetts': 3.35, 'ma': 3.35,
  'connecticut': 3.30, 'ct': 3.30,
  'rhode island': 3.28, 'ri': 3.28,
  'vermont': 3.25, 'vt': 3.25,
  'new hampshire': 3.20, 'nh': 3.20,
  'maine': 3.22, 'me': 3.22,
  'pennsylvania': 3.25, 'pa': 3.25,
  'new jersey': 3.20, 'nj': 3.20,
  'delaware': 3.10, 'de': 3.10,
  'maryland': 3.15, 'md': 3.15,
  'district of columbia': 3.30, 'dc': 3.30,
  'west virginia': 2.95, 'wv': 2.95,
  
  // Midwest
  'illinois': 3.30, 'il': 3.30,
  'michigan': 3.15, 'mi': 3.15,
  'wisconsin': 2.95, 'wi': 2.95,
  'minnesota': 2.90, 'mn': 2.90,
  'iowa': 2.85, 'ia': 2.85,
  'missouri': 2.75, 'mo': 2.75,
  'ohio': 2.95, 'oh': 2.95,
  'indiana': 2.90, 'in': 2.90,
  'north dakota': 2.85, 'nd': 2.85,
  'south dakota': 2.80, 'sd': 2.80,
  'nebraska': 2.80, 'ne': 2.80,
  'kansas': 2.70, 'ks': 2.70,
  
  // South (generally lower)
  'florida': 3.10, 'fl': 3.10,
  'georgia': 2.85, 'ga': 2.85,
  'north carolina': 2.90, 'nc': 2.90,
  'south carolina': 2.80, 'sc': 2.80,
  'virginia': 2.95, 'va': 2.95,
  'tennessee': 2.70, 'tn': 2.70,
  'kentucky': 2.80, 'ky': 2.80,
  
  // Gulf states (lowest prices)
  'texas': 2.65, 'tx': 2.65,
  'louisiana': 2.60, 'la': 2.60,
  'oklahoma': 2.55, 'ok': 2.55,
  'mississippi': 2.55, 'ms': 2.55,
  'alabama': 2.60, 'al': 2.60,
  'arkansas': 2.60, 'ar': 2.60,
  
  // Mountain states
  'colorado': 3.10, 'co': 3.10,
  'arizona': 3.20, 'az': 3.20,
  'utah': 3.15, 'ut': 3.15,
  'new mexico': 2.90, 'nm': 2.90,
  'idaho': 3.25, 'id': 3.25,
  'montana': 3.00, 'mt': 3.00,
  'wyoming': 3.05, 'wy': 3.05,
};
